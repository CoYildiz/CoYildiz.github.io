...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/Sekiro.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/CoYildiz", // Internal links should not include the base path, as it is automatically added
